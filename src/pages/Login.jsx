        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-xl p-8 rounded-3xl border border-cyan-500/20 shadow-2xl">
            ...
            <div className="relative">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-white mb-3">Connect to the World</h2>
                <p className="text-gray-400 leading-relaxed">
                  Join millions of users worldwide. Secure your digital assets and connect to the global blockchain ecosystem.
                </p>
              </div>
